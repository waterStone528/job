...
var M0202 = {
    ...
    STR: {
        EVINIT: function (Num) {
            ...
            setTimeout("for (var i = 1 ; i <= " + Num + "; i++) {if(i%4!=0) {M0202.UID.M020210(\"USSSS0\" + i, \"姓名\" + i,4, 5, 6, 3, 2, 3, \"609\", \"通过\", 1);}else{M0202.UID.M020210(\"USSSS0\" + i, \"姓名\" + i,0, 0, 0, 0, 0, 0, \"609\", \"未通过\", 1);} };M0202.UID.M020209(false, " + Num + ");", 100);
            M0202.UID.M020211();
        },//初始化页面
