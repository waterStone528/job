...
var TransingStatus = {
    StatusCode: 0,
    DelayClose: function () {
        window.setTimeout("TransingBoxi.style.display = 'none';TransingBoxi.querySelector('.LoseReason').style.display = 'none';", 3000);
    },
    SetStatus: function (StatusCode,Str) {
        this.StatusCode = StatusCode;
        switch (StatusCode) {
            case 2:
                TransingBox.querySelector("label").innerText = "操作失败";
                ...
                break;
            case 1:
                TransingBox.querySelector("label").innerText = "操作执行中.....";
                ...
                break;
            case 3:
                TransingBox.querySelector("label").innerText = "操作执行成功";
                TransingBox.querySelectorAll('div')[0].style.display = 'block';
                TransingBox.querySelector("img").style.display = "none";
                TransingBox.querySelectorAll('div')[0].className = 'icon-Success';
